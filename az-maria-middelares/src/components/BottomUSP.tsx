...
export default function BottomUSP() {
  const accent = brand.colors.secondary;
  return (
    <>
      ...
      <div className="service-bar">
        <div className="svc-item">
          <Truck size={22} strokeWidth={1.75} color={accent} className="svc-icon" />
          <div className="svc-text">
            <strong>Binnen 4 uur geleverd</strong>
            <span>Snel schakelen bij acute zorgvragen</span>
          </div>
        </div>
        <div className="svc-item">
          <Wrench size={22} strokeWidth={1.75} color={accent} className="svc-icon" />
          <div className="svc-text">
        ...
        <div className="svc-item">
          <Sparkles size={22} strokeWidth={1.75} color={accent} className="svc-icon" />
          <div className="svc-text">
        ...
        <div className="svc-item">
          <QrCode size={22} strokeWidth={1.75} color={accent} className="svc-icon" />
          <div className="svc-text">
